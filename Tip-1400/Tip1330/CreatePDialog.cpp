      ...
      case WM_COMMAND :
              switch( LOWORD( wParam ) )
              {
                 case IDM_TEST :
                        if ( !hDlgModeless )
                        {
                           hDlgModeless = CreateDialogParam( hInst,
                                                         "TestDialog",
                                                         hWnd,
                                                         (DLGPROC)TestDlgProc,
                                                         (LPARAM)lpMem );
...
static LPDLGDATA lpMem;
   ...
   switch( uMsg )
   {
      ...
      case WM_INITDIALOG :
            ...
            CheckDlgButton( hDlg, IDC_CHECKBOX, lpMem->bChecked ? MF_CHECKED :
                                                           MF_UNCHECKED );
            CheckRadioButton( hDlg, IDC_RADIO1, IDC_RADIO2, 
                           lpMem->bRadio1 ? IDC_RADIO1 : IDC_RADIO2 );
            break;
      ...
      case WM_COMMAND :
            ...
            {
               case IDC_CHECKBOX :
                      lpMem->bChecked = !IsDlgButtonChecked( hDlg, IDC_CHECKBOX );
                      CheckDlgButton( hDlg, IDC_CHECKBOX, 
                                      lpMem->bChecked ? MF_CHECKED : MF_UNCHECKED );
                      break;
